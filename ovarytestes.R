...
plot(scores[1:160,1], scores[1:160,2], xlab="PC1 (76%)", ylab="PC2 (13%)", pch=18, col=1, xlim=c(-.15,.15), ylim=c(-.2,.15))
...
legend(-.15, -.12, cex=0.8, pch=c(18,8,17), col = (1:4), expression(paste(italic("Benedenia A")), paste(italic("Benedenia B")), paste(italic("Neobenedenia B"))))
